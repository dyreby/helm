...
Helm is a TUI (terminal user interface) written in Rust and inspired by, among other things, John Boyd's OODA loop, Michael Singer's worldview of asking how best to serve the moment unfolding in front of you, and my dad's love of sailing. It's a personal tool, deeply shaped by how I think, tuned to my intervention style, and not trying to be general.
