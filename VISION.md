...
An autonomous agent with tools is the wrong shape for how I want to collaborate with an LLM. I want to set the course, trust the agent to crew the voyage, and review the logbook along the way.
...
- **Permanent record.** What's recorded stays recorded.
- **Trust the voyage.** The record is always yours to review.
